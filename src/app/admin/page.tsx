...
export default function Admin() {
  ...
  const [reportType, setReportType] = useState<"daily" | "monthly" | "yearly">("daily"); // Tipo de relatório
  const [selectedDate, setSelectedDate] = useState<string>(""); // Data selecionada
  const [reportData, setReportData] = useState<DailyReport[] | MonthlyReport[] | YearlyReport[]>([]); // Dados do relatório
